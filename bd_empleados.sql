...
select concat(nombre, ' ', apellido1, ' ', ifnull(apellido2, '')) as NombreCompleto from empleado;
-- 8. Lista el nombre y apellidos de los empleados en una única columna, convirtiendo todos los caracteres en mayúscula.
select upper(concat(nombre, ' ', apellido1, ' ', ifnull(apellido2, ''))) as NombreCompleto from empleado;
-- 9. Lista el nombre y apellidos de los empleados en una única columna, convirtiendo todos los caracteres en minúscula.
select lower(concat(nombre, ' ', apellido1, ' ', ifnull(apellido2, ''))) as NombreCompleto from empleado;
